...
public class MainMenuUIController : MonoBehaviour {
    ...
    private void Start() {
        ...
        statsValueBuilder.AppendLine($"{GameManager.Instance.PlayerData.ShootsFired} F");
        statsBuilder.AppendLine("Kills");
        statsValueBuilder.AppendLine($"{GameManager.Instance.PlayerData.Kills} K");
        statsBuilder.AppendLine($"Deaths");
        statsValueBuilder.AppendLine($"{GameManager.Instance.PlayerData.Deaths} D");
        statsBuilder.AppendLine($"K/D Ratio");
        statsValueBuilder.AppendLine($"{GameManager.Instance.PlayerData.GetPlayerKD()} KD");
